...
/**
 * Paperコンポーネントに'highlighted'バリアントを追加
 */
...
/**
 * MUIテーマ型の拡張
 * - PaletteとPaletteOptionsの両方にbaseShadowを追加
 */
 ...
 * - 全体で25個保持
 */
export const shadows = defaultTheme.shadows.map((shadow, index) =>
  index === 1 ? "var(--template-palette-baseShadow)" : shadow
) as Shadows;
...
/**
 * Light/Dark別のカラー設定（colorSchemes）
 */
